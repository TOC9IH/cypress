describe('Проверка покупки нового аватара', function () {                 // название набора тестов
    it('e2e тест на покупку нового аватара для тренера', function () {   // название теста
         ...
         cy.get('input[id="k_email"]').type('USER_LOGIN');                   // вводим логин вместо USER_LOGIN вводим свой логин
         cy.get('input[id="k_password"]').type('USER_PASSWORD');               // вводим пароль вместо USER_PASSWORD вводим свой пароль
